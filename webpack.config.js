...
// Define Work path
const destFileCss = destChildTheme + "/assets/frontend/sass/app.scss";
const destAdminFileCss = destChildTheme + "/assets/backend/sass/app.scss";
const destAdminFileJs = destChildTheme + "/assets/backend/js/index.js";
const destDocFileJs = destChildTheme + "/docs/index.js";
const destFileJs = destChildTheme + "/assets/frontend/js/index.js";
